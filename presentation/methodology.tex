...
\end{frame}
    ...
    \begin{frame}{Lexical features}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Mean of the maximum similarity using: Lin similarity and Resnik similarity: $resniksim(S_1,S_2) = ic(LCS(S_1,S_2))$ 
                \item Mean weighted by Inverse Document Frequency (IDF) coefficient.
